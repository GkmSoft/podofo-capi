...
virtual PoDoFo::PdfString GetMD5String(const unsigned char* pBuffer, int nLength) = 0;
virtual void GetMD5Binary(const unsigned char* data, int length, unsigned char* digest) = 0;
virtual PoDoFo::pdf_long CalculateStreamLength(PoDoFo::pdf_long length) const = 0;
virtual PoDoFo::pdf_long CalculateStreamOffset() const = 0;
virtual bool Authenticate(const char* documentID, const char* password, const char* uValue, const char* oValue, int pValue, int lengthValue, int rValue) = 0;
