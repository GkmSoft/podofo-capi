...
virtual ~PdfObjectImpl() {}
virtual PoDoFo::PdfObjectImpl* GetIndirectKey(PoDoFo::PdfName key) const = 0;
virtual PoDoFo::PdfObjectImpl* MustGetIndirectKey(PoDoFo::PdfName key) const = 0;
virtual void WriteObject(PoDoFo::PdfOutputDeviceImpl* pDevice, PoDoFo::EPdfWriteMode eWriteMode, PoDoFo::PdfEncryptImpl* pEncrypt, PoDoFo::PdfName keyStop) const = 0;
virtual PoDoFo::pdf_long GetObjectLength(PoDoFo::EPdfWriteMode eWriteMode) = 0;
virtual PoDoFo::PdfReference Reference() const = 0;
virtual PoDoFo::PdfStreamImpl* GetStream() = 0;
