...
virtual ~PdfEncrypt() {}
virtual PoDoFo::PdfEncrypt* CreatePdfEncrypt(const char* userPassword, const char* ownerPassword, int protection, PoDoFo::PdfEncrypt::EPdfEncryptAlgorithm eAlgorithm, PoDoFo::PdfEncrypt::EPdfKeyLength eKeyLength) = 0;
...
virtual bool IsEncryptionEnabled(PoDoFo::PdfEncrypt::EPdfEncryptAlgorithm eAlgorithm) = 0;
