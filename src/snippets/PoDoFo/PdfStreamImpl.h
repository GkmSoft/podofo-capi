...
virtual ~PdfStreamImpl() {}
virtual void Write(PoDoFo::PdfOutputDeviceImpl* pDevice, PoDoFo::PdfEncryptImpl* pEncrypt) = 0;
...
virtual void Set(PoDoFo::PdfInputStreamImpl* pStream) = 0;
virtual void Set(PoDoFo::PdfInputStreamImpl* pStream, PoDoFo::TVecFilters vecFilters) = 0;
virtual void Set(const char* pszString) = 0;
virtual void SetRawData(PoDoFo::PdfInputStreamImpl* pStream, PoDoFo::pdf_long lLen) = 0;
...
virtual void GetCopy(PoDoFo::PdfOutputStreamImpl* pStream) const = 0;
virtual void GetFilteredCopy(char** pBuffer, Bcapi::PdfLongImpl lLen) const = 0;
virtual void GetFilteredCopy(PoDoFo::PdfOutputStreamImpl* pStream) const = 0;
