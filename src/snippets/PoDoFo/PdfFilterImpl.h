...
virtual void BeginEncode(PoDoFo::PdfOutputStreamImpl* pOutput) = 0;
...
virtual void BeginDecode(PoDoFo::PdfOutputStreamImpl* pOutput, PoDoFo::PdfDictionary* pDecodeParms) = 0;
virtual void DecodeBlock(const char* pBuffer, PoDoFo::pdf_long lLen) = 0;
virtual void EndEncode() = 0;
virtual PoDoFo::EPdfFilter GetType() const = 0;
virtual PoDoFo::PdfOutputStreamImpl* GetStream() const = 0;
