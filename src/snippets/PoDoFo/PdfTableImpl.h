...
virtual void GetWidth(double dX, double dY, PoDoFo::PdfCanvasImpl* pPage) = 0;
virtual void GetHeight(double dX, double dY, PoDoFo::PdfCanvasImpl* pPage) = 0;
...
virtual PoDoFo::PdfTableModelImpl* GetModel() const = 0;
virtual void SetModel(PoDoFo::PdfTableModelImpl* model) = 0;
