...
virtual void WriteObject(PoDoFo::PdfObjectImpl* pObject) = 0;
virtual void ParentDestructed() = 0;
virtual void BeginAppendStream(PoDoFo::PdfStreamImpl* pStream) = 0;
virtual void EndAppendStream(PoDoFo::PdfStreamImpl* pStream) = 0;
