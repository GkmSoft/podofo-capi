...
virtual void SetURI(PoDoFo::PdfString uri) = 0;
virtual PoDoFo::PdfString GetScript() const = 0;
virtual void SetScript(PoDoFo::PdfString script) = 0;
