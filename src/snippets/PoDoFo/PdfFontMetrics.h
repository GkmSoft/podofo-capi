...
virtual double StringWidth(PoDoFo::PdfString rsString) const = 0;
virtual double StringWidth(const char* pszText, PoDoFo::pdf_long nLength) const = 0;
virtual double StringWidth(PoDoFo::pdf_utf16be* pszText, unsigned nLength) const = 0;
virtual double StringWidth(const wchar_t* pszText, unsigned nLength) const = 0;
virtual double StringWidth(const char* pszText, unsigned nLength) const = 0;
virtual double StringWidth(PoDoFo::pdf_utf16be* pszText, unsigned nLength) const = 0;
virtual double StringWidth(const wchar_t* pszText, unsigned nLength) const = 0;
virtual double CharWidth(unsigned char c) const = 0;
virtual double UnicodeCharWidth(unsigned char c) const = 0;
virtual unsigned long CharWidthMM(unsigned char c) const = 0;
virtual double GetLineSpacing() const = 0;
virtual unsigned long GetLineSpacingMM() const = 0;
virtual unsigned long GetUnderlineThickness() const = 0;
virtual double GetLineSpacing() const = 0;
virtual double GetLineSpacingMM() const = 0;
virtual double GetUnderlineThickness() const = 0;
virtual double GetUnderlinePosition() const = 0;
virtual long GetUnderlinePositionMM() const = 0;
virtual double GetStrikeOutPosition() const = 0;
virtual unsigned long GetStrikeOutPositionMM() const = 0;
virtual double GetStrikeoutThickness() const = 0;
virtual unsigned long GetStrikeoutThicknessMM() const = 0;
...
virtual const char* GetSubsetFontnamePrefix() const = 0;
...
virtual PoDoFo::EPdfFontType FontTypeFromFilename(const char* pszFilename) = 0;
