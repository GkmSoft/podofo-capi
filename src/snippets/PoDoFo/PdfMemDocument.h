...
virtual void WriteUpdate(PoDoFo::PdfOutputDevice* rDevice, bool bTruncate) = 0;
...
virtual void SetEncrypted(const char* userPassword, const char* ownerPassword, int protection, PoDoFo::PdfEncrypt::EPdfEncryptAlgorithm eAlgorithm, PoDoFo::PdfEncrypt::EPdfKeyLength eKeyLength) = 0;
...
virtual PoDoFo::PdfMemDocument* InsertPages(PoDoFo::PdfMemDocument rDoc, int inFirstPage, int inNumPages) = 0;
...
virtual void FreeObjectMemory(PoDoFo::PdfObject* pObj, bool bForce) = 0;
