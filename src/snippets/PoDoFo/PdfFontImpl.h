...
virtual PoDoFo::PdfEncodingImpl* GetEncoding() const = 0;
virtual PoDoFo::PdfFontMetricsImpl* GetFontMetrics() const = 0;
virtual PoDoFo::PdfFontMetricsImpl* GetFontMetrics2() = 0;
virtual void WriteStringToStream(PoDoFo::PdfString rsString, PoDoFo::PdfStreamImpl* pStream) = 0;
virtual void EmbedFont() = 0;
virtual void AddUsedSubsettingGlyphs(PoDoFo::PdfString sText, long lStringLen) = 0;
virtual void WriteStringToStream(PoDoFo::PdfString pszGlyphName, PoDoFo::PdfStreamImpl* pStream) = 0;
